...
parser.add_argument('--arch', type=str, default='alexnet', choices=['alexnet', 'vgg16'], 
                                                           help='architecture')
...
parser.add_argument('--step', type=int, default=5, help='nb of iters between gaussian blurs.')
parser.add_argument('--niter', type=int, default=1000, help='total number of iterations')
